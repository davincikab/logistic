...
class AccountEmployee(models.Model):
    ...
    class Meta:
        managed = False
        db_table = 'account_employee'


class AccountShopowner(models.Model):
    user = models.OneToOneField('AccountUser', models.DO_NOTHING)

    class Meta:
        managed = False
        db_table = 'account_shopowner'
...
class AccountUser(models.Model):
    ...
    is_shopowner = models.BooleanField()
...
class Customers(models.Model):
    ...
    date = models.CharField(max_length=-1, blank=True, null=True)
    route_code = models.CharField(db_column='route code', max_length=-1, blank=True, null=True)  # Field renamed to remove unsuitable characters.
    route_name = models.CharField(db_column='route name', max_length=-1, blank=True, null=True)  # Field renamed to remove unsuitable characters.
    ...
    account_name = models.CharField(db_column='account name', max_length=-1, blank=True, null=True)  # Field renamed to remove unsuitable characters.
